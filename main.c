...
void ft812_paramWindowCustom(void){
  ...
  ft_custom_font_edit("�������� ����"); FT8_cmd_text(10,5, 11, 0, outstring);
  ...
  FT8_cmd_dl(DL_COLOR_RGB | 0xffff00);
  ft_custom_font_edit("������"); FT8_cmd_text(10,10+offset, 11, 0, outstring);
  
  ft_custom_font_edit("������ �����"); FT8_cmd_text(10,30+offset, 11, 0, outstring);

  ft_custom_font_edit("����"); FT8_cmd_text(10,50+offset, 11, 0, outstring);

  ft_custom_font_edit("����"); FT8_cmd_text(10,70+offset, 11, 0, outstring);  

  ft_custom_font_edit("����������"); FT8_cmd_text(10,90+offset, 11, 0, outstring); 
  
  ft_custom_font_edit("�����������"); FT8_cmd_text(10,110+offset, 11, 0, outstring); 
